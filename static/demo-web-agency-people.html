...
<html class="no-js" lang="en">
    ...
    <body
        ...
        class="background-position-center-top"
        style="
    ...
    >
        ...
        <header>
            <!-- start navigation -->
            <nav
                class="navbar navbar-expand-lg header-light header-transparent bg-transparent disable-fixed"
            >
                    ...
                    <div class="col-auto col-lg-2 me-lg-0 me-auto">
                        <a class="navbar-brand" href="demo-web-agency.html">
                            <img
                                ...
                                data-at2x="images/demo-web-agency-logo-black@2x.png"
                                alt=""
                                class="default-logo"
                            />
                            <img
                    ...
                    <div class="col-auto col-lg-8 menu-order position-static">
                        ...
                        >
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a
                                        href="demo-web-agency-about.html"
                                        class="nav-link"
                                        >Agency</a
                                    >
                                </li>
                                <li
                                    class="nav-item dropdown dropdown-with-icon"
                                >
                                    <a
                                        href="demo-web-agency-expertise.html"
                                        class="nav-link"
                                        >Expertise</a
                                    >
                                    <i
                                    ...
                                    >
                                        <li>
                                            <a
                                                href="demo-web-agency-services-details.html"
                                            >
                                                <img
                                                    src="/images/demo-web-agency-expertise-06.png"
                                                    class="w-40px"
                                                    alt=""
                                                />
                                                <div
                                                    class="submenu-icon-content"
                                                >
                                        ...
                                        <li>
                                            ...
                                            >
                                                <img
                                                    src="/images/demo-web-agency-expertise-07.png"
                                                    class="w-40px"
                                                    alt=""
                                                />
                                                <div
                                        ...
                                        <li>
                                            ...
                                            >
                                                <img
                                                    src="/images/demo-web-agency-expertise-08.png"
                                                    class="w-40px"
                                                    alt=""
                                                />
                                                <div
                                        ...
                                        <li>
                                            ...
                                            >
                                                <img
                                                    src="/images/demo-web-agency-expertise-09.png"
                                                    class="w-40px"
                                                    alt=""
                                                />
                                                <div
                                ...
                                <li class="nav-item">
                                    <a
                                        href="demo-web-agency-projects.html"
                                        class="nav-link"
                                        >Projects</a
                                    >
                                </li>
                                <li class="nav-item">
                                    <a
                                        href="demo-web-agency-people.html"
                                        class="nav-link"
                                        >People</a
                                    >
                                </li>
        ...
        <section class="p-0 top-space-margin page-title-center-alignment">
            <div class="container">
                <div
                    class="row align-items-center justify-content-center extra-very-small-screen"
                >
                    <div
                        class="col-xl-8 col-lg-10 text-center position-relative page-title-extra-large"
                        data-anime='{ "el": "childs", "translateY": [-15, 0], "opacity": [0,1], "duration": 300, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'
                    >
                        <h1 class="fw-700 text-dark-gray mb-20px ls-minus-2px">
                            People
                        </h1>
                        <h2 class="fw-400 ls-0px mb-0">
                            Meet our highly creative team
                        </h2>
                    </div>
                </div>
            </div>
        ...
        <section class="p-0 md-pt-50px position-relative">
            <div
                class="position-absolute left-minus-50px lg-left-minus-150px top-25 md-top-25px"
            ...
            <div class="container">
                <div
                    class="row align-items-end align-items-lg-center border-bottom border-color-dark-gray position-relative"
                >
                    <div class="col-md-6 order-2 order-md-1 text-center">
                        <img
                            class="position-relative bottom-minus-1px"
                            src="/images/idamairemovebg.png"
                            alt=""
                        />
                    </div>
                    <div
                    ...
                    >
                        <div class="icon-with-text-style-08 mb-25px">
                            ...
                            >
                                ...
                                >
                                    <i
                                        class="fa-solid fa-heart text-dark-gray"
                                    ></i>
                                </div>
                                <div class="feature-box-content">
                                    <span
                                        class="d-inline fs-15 lh-24 fw-700 text-dark-gray text-uppercase text-decoration-line-bottom"
                                        >Together we can achieve more</span
                                    >
                                </div>
                            </div>
                        </div>
                        <h5
                            class="text-dark-gray lh-40 fw-400 mb-20px ls-minus-1px"
                        >
                            You don't need a group of super stars, you need a
                            team
                            <span
                                class="fw-600 text-decoration-line-bottom-medium"
                                >working together to bring</span
                            >
                            you better results you need team.
                        </h5>
                        <img
                            src="images/demo-web-agency-people-05.png"
                            alt=""
                        />
                        <div class="fs-18 text-dark-gray mt-5px">
                            <span class="fw-600">Herman miller,</span> Co
                            founder
                        </div>
                    </div>
                    <img
                        src="images/demo-web-agency-people-06.png"
                        class="position-absolute bottom-minus-15px right-0px w-auto"
                        alt=""
                    />
                </div>
            </div>
        ...
        <section class="overflow-hidden position-relative half-section pb-0">
            <div class="container-fluid">
                <div class="row position-relative">
                    <div
                        class="col swiper swiper-width-auto text-center pb-30px md-pb-20px xs-pb-10px"
                    ...
                    >
                        <div class="swiper-wrapper marquee-slide">
                            ...
                            <div class="swiper-slide">
                                <div
                                    class="fs-170 sm-fs-150 text-base-color fw-600 ls-minus-8px word-break-normal"
                                >
                                    developers
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div
                                    class="fs-170 sm-fs-150 text-dark-gray fw-600 ls-minus-8px word-break-normal"
                                >
                                    designers
                                </div>
                            </div>
        ...
        <section>
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2">
                    ...
                    <div
                        class="col text-center team-style-05 mb-30px mt-3 lg-mt-0"
                        data-bottom-top="transform: translateY(30px)"
                        data-top-bottom="transform: translateY(-30px)"
                    >
                        <div
                            class="position-relative mb-30px last-paragraph-no-margin border-radius-6px overflow-hidden"
                        >
                    ...
                    <!-- start team member item -->
                    <div
                        class="col text-center team-style-05 mb-30px"
                        data-bottom-top="transform: translateY(-30px)"
                        data-top-bottom="transform: translateY(30px)"
                    >
                        <div
                    ...
                    <!-- start team member item -->
                    <div
                        class="col text-center team-style-05 md-mb-30px"
                        data-bottom-top="transform: translateY(30px)"
                        data-top-bottom="transform: translateY(-30px)"
                    >
                        <div
                        ...
                        <div class="fw-600 text-dark-gray lh-22">
                            Michal ruheen
                        </div>
                    ...
                    <!-- start team member item -->
                    <div
                        class="col text-center team-style-05 xs-mb-30px"
                        data-bottom-top="transform: translateY(30px)"
                        data-top-bottom="transform: translateY(-30px)"
                    >
                        <div
                    ...
                    <!-- start team member item -->
                    <div
                        class="col text-center team-style-05"
                        data-bottom-top="transform: translateY(-30px)"
                        data-top-bottom="transform: translateY(30px)"
                    >
                        <div
            ...
            <div class="container">
                <div class="row mb-6">
                    <div class="col-lg-5 text-center text-md-start">
                        <div
                            class="position-sticky top-100px md-top-0px md-position-relative"
                        >
                            <div
                            ...
                            <h3
                                class="text-dark-gray fw-600 w-70 lg-w-80 md-w-100 ls-minus-2px"
                            >
                    ...
                    <div
                        class="col-lg-7 text-center text-md-start"
                    ...
                    >
                        <div class="row">
                            <div class="col-md-5">
                                <div
                                    class="fs-20 fw-600 text-dark-gray w-90 xl-w-100 sm-mb-10px lh-30"
                                >
                                    Build a greatest career with crafto agency.
                                </div>
                            </div>
                            <div class="col-md-7 last-paragraph-no-margin">
                                <p>
                                    We value each and every human life placed
                                    our hands constantly work towards meeting
                                    the expectations of our customers.
                                </p>
                            </div>
                        </div>
                        <div
                            class="separator-line-1px border-bottom border-color-dark-gray mt-35px mb-35px"
                        ></div>
                        <div class="row">
                            <div class="col-md-5">
                                <div
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div
                                    class="fs-20 fw-600 text-dark-gray w-90 xl-w-100 sm-mb-10px lh-30"
                                >
                                    Only for interested to freelance work.
                                </div>
                            </div>
                            <div class="col-md-7 last-paragraph-no-margin">
                                <p>
                ...
                <div class="row">
                    <div
                        class="col-12 fs-22 text-center text-dark-gray ls-minus-05px md-mb-30px"
                    >
                        We cultivate creativity and innovation together.
                        <a
                            href="#"
                            class="fw-600 text-dark-gray text-dark-gray-hover text-decoration-line-bottom-medium"
                            >Want to join us?</a
                        >
                    </div>
                </div>
        ...
        <!-- start section -->
        <section
            class="pb-4 sm-pt-30px sm-pb-40px overflow-hidden position-relative"
        >
            <div class="container">
                <div class="row">
                    <div class="col-sm-5 text-center text-sm-start">
                        <div
                            class="outside-box-left-25 xl-outside-box-left-10 sm-outside-box-left-0"
                        >
                            <div
                    ...
                    <div class="col-sm-7 text-center text-sm-end">
                        <div class="outside-box-right-5 sm-outside-box-right-0">
                            ...
                            >
                                ...
                                >
                                    <img
                                        src="images/demo-web-agency-05.png"
                                        class="animation-rotation"
                                        alt=""
                                    />
                                    <div
                                        class="absolute-middle-center w-100 z-index-minus-1"
                                    >
                                        <img
                                            src="images/demo-web-agency-04.png"
                                            alt=""
                                        />
                                    </div>
                                </div>
        ...
        <footer class="p-0">
            <div class="container">
                <div class="row align-items-center mb-4 sm-mb-6">
                    <div
                        class="col-md-10 col-sm-8 text-center text-sm-start xs-mb-25px"
                    >
                        <h5 class="mb-0 text-dark-gray fw-400 ls-minus-1px">
                            Let's make something great
                            <a
                                href="demo-web-agency-contact.html"
                                class="text-decoration-line-bottom-medium fw-600 text-dark-gray text-dark-gray-hover"
                                >work together?</a
                            >
                        </h5>
                    </div>
                ...
                <div class="row align-items-end mb-6 sm-mb-40px">
                    <!-- start footer column -->
                    <div
                        class="col-lg-3 col-sm-4 text-center text-sm-start xs-mb-25px last-paragraph-no-margin"
                    >
                        <span
                    ...
                    <!-- start footer column -->
                    <div
                        class="col-md-3 col-sm-4 last-paragraph-no-margin ms-auto text-center text-sm-end"
                    >
                        <a
                            href="tel:1235678901"
            ...
            <div
                class="footer-bottom pt-25px pb-25px border-top border-color-charcoal-grey"
            >
                <div class="container">
                    <div class="row align-items-center">
                        <div
                            class="col-lg-7 text-center text-lg-start md-mb-10px"
                        >
